...
from newsletter.app_settings import NEWSLETTER_SITE_BASE_URL
...
def send_subscription_verification_email(verification_url, to_email):
    ...
    text_body = render_to_string(
        'newsletter/email/email_verification.txt', context
    )
    html_body = render_to_string(
        'newsletter/email/email_verification.html', context
    )
